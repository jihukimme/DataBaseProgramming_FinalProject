...
namespace _5584639_FinalProject
{
    public partial class Form3 : Form
    {
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            ...
            openChildForm(new Form3_ChildForm.Form3_Home(customer_id));
        ...
        private void iconButton2_Click(object sender, EventArgs e)
        {
            ...
            openChildForm(new Form3_ChildForm.Form3_Item(customer_id));
        }
        ...
        private void iconButton3_Click(object sender, EventArgs e)
        {
            ...
            openChildForm(new Form3_ChildForm.Form3_Cart(customer_id));
        ...
        private void iconButton4_Click(object sender, EventArgs e)
        {
            ...
            openChildForm(new Form3_ChildForm.Form3_Purchase(customer_id));
        }
        ...
        private void iconButton6_Click(object sender, EventArgs e)
        {
            ...
            openChildForm(new Form3_ChildForm.Form3_User(customer_id, this));
        }
        ...
        private void iconButton7_Click(object sender, EventArgs e)
        {
            ...
            openChildForm(new Form3_ChildForm.Form3_Refund(customer_id));
        }
    }
}
