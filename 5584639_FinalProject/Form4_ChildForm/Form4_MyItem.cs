...
{
    public partial class Form4_MyItem : Form
    {
        ...
        private void Form4_MyItem_Load(object sender, EventArgs e)
        {
            ...
            iTEMBindingSource.Filter = $"SELLER_ID = '{seller_id}'";
        }
        ...
        private void iconButton2_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.CurrentRow.Cells[6].Value = seller_id;
