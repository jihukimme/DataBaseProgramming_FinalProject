...
{
    public partial class Form5_RealItemSales : Form
    {

        DataTable mytable1;

        public Form5_RealItemSales()
        {
            InitializeComponent();
        ...
        private void Form5_RealItemSales_Load(object sender, EventArgs e)
        {
            ...
            this.purchasE_PRICE_SUMTableAdapter1.Fill(this.dataSet11.PURCHASE_PRICE_SUM);

            DataView dv = new DataView(this.dataSet11.PURCHASE_PRICE_SUM);
            ...
            foreach (DataRowView rowView in dv)
            {
                ...
                // NULL 값은 0으로 처리합니다.
                int purchasePrice = row["TOTAL_PURCHASE_PRICE"] == DBNull.Value ? 0 : Convert.ToInt32(row["TOTAL_PURCHASE_PRICE"]);

                totalPurchasePrice += purchasePrice;
            }

            // 합계를 표시합니다.
            label4.Text = totalPurchasePrice.ToString();
        }
